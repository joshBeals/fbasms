        ...
        try {
            ...
            if(!$decoded){
                ...
                if(
                    ...
                    // display message: session was created
                    echo $term->editTerm($data->id,$data->term);
                }
                
                // message if unable to create term
                else{
                
                    // set response code
                    http_response_code(400);
                
                    // display message: unable to create term
