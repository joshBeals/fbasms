    ...
    if($jwt){
        ...
        try {
            ...
            if(!$decoded){
                ...
                // create the classes
                if(
                    !empty($data->classname)
                ){
                
                    // set response code
                    http_response_code(200);
                
                    // display message: classes was created
                    echo $classes->editClass($data->id,$data->classname);
                }
                
                // message if unable to create classes
                else{
                
                    // set response code
                    http_response_code(400);
                
                    // display message: unable to create classes
