<?php
    ...
    if($jwt){
        ...
        try {
            ...
            // set property values
            $teacher->teacherID = $data->teacher;
            $teacher->subID = $data->subject;
            $teacher->classID = $data->class;

            // create the teacher
            if(
                !empty($teacher->teacherID) &&
                !empty($teacher->subID) &&
                !empty($teacher->classID)
            ){
