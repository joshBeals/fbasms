<?php
    ...
    if($jwt){
        ...
        try {
            ...
            // create the subjects
            if(
                !empty($subjects->subject)
            ){
            
                // set response code
                http_response_code(200);
            
                // display message: subjects was created
                echo $subjects->create();
            }
            
            // message if unable to create subjects
            else{
            
                // set response code
                http_response_code(400);
            
                // display message: unable to create subjects
